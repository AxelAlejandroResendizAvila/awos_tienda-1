...
const Productos = () => {
  ...
  const [nuevoProducto, setNuevoProducto] = useState({
    nombre: '', precio: '', stock: '', imagen_url: '', categoria_id: 1, youtube_id: '', latitud: 20.5865153, longitud: -100.3901229
  });
  ...
  const handleCrear = async (e) => {
    ...
    try {
      ...
      setNuevoProducto({ nombre: '', precio: '', stock: '', imagen_url: '', categoria_id: 1, youtube_id: '', latitud: 20.5865153, longitud: -100.3901229 });
    } catch (err) {
